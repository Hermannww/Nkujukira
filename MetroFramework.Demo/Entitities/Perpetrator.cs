...
namespace MetroFramework.Demo.Entitities
{
    public class Perpetrator
    {
        ...
        public Perpetrator(Bitmap[] faces,bool is_active,String gender)
        {
        ...
        public Perpetrator(int id1, string name1, Bitmap[] faces1, bool is_a_student1, bool is_active, string gender1,String created_at)
        {
