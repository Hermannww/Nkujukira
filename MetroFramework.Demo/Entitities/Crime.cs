...
namespace MetroFramework.Demo.Entitities
   ...
   public class Crime
       ...
       public Crime(int id,String date,String details,String type,String crime,String time,int perpetrator_id,String created_at) 
                                     {
           this.id               = id;
       ...
       public Crime(String date,String details, String type,String crime,String time,int perpetrator_id)
                                     {
           this.date_of_crime    = date;
           this.details_of_crime = details;
           this.type_of_crime    = type;
